...
class TestExtract : ICommand {
    ...
    override fun addArguments(builder: LiteralArgumentBuilder<CommandSource>) {
        builder.then(Commands.argument("chemicalName", StringArgumentType.string()).executes() {
            ...
            extractItems(it, chemicalName, amount)
    ...
    private fun extractItems(
        ...
        try {
            ...
            inventory.extractItems(aeStack, Actionable.MODULATE, PlayerSource(it.source.asPlayer(), null))
        } catch (e: Throwable) {
