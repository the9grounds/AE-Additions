...
class ItemWirelessTerminalUniversal : WirelessTermBase(), IWirelessFluidTermHandler, IWirelessGasTermHandler, IWirelessTermHandler, IWirelessCraftingTerminalItem {
    ...
    override fun getItemStackDisplayName(stack: ItemStack): String {
        ...
        // TODO: Bug here
        return super.getItemStackDisplayName(stack) + " - " + I18n.translateToLocal("com.the9grounds.aeadditions.tooltip." + WirelessTerminalType.values()[tag.getByte("type").toInt()].toString().toLowerCase())
    }
    ...
    override fun addInformation(stack: ItemStack, worldIn: World?, tooltip: MutableList<String>, flagIn: ITooltipFlag) {
        ...
        tooltip.add(I18n.translateToLocal("com.the9grounds.aeadditions.tooltip.mode") + ": " + I18n.translateToLocal("com.the9grounds.aeadditions.tooltip." + WirelessTerminalType.values()[tag.getByte("type").toInt()].toString().toLowerCase()))
