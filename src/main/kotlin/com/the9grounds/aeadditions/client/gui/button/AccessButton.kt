...
class AccessButton(parent: MEWirelessTransceiverScreen, var isPrivate: Boolean = false) : Button(0, 0, 16, 16, Component.empty(), parent::accessButtonPressed, parent::accessBtnTooltip) {
