...
class ClearChannelButton(parent: MEWirelessTransceiverScreen, val font: Font) : Button(0, 0, 14, 14, TextComponent.EMPTY, parent::clearChannelButtonPressed) {
    override fun renderButton(poseStack: PoseStack, p_93747_: Int, p_93748_: Int, p_93749_: Float) {
        ...
        font.draw(poseStack, "Clear", 7.5f, 4f, Color(0, 0, 0, 1).toARGB())
        poseStack.popPose()
    }
}