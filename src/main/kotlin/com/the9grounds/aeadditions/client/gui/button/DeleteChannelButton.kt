...
class DeleteChannelButton(parent: MEWirelessTransceiverScreen, val font: Font) : Button(0, 0, 40, 16, TextComponent.EMPTY, parent::deleteChannelButtonPressed) {
    override fun renderButton(poseStack: PoseStack, p_93747_: Int, p_93748_: Int, p_93749_: Float) {
        ...
        font.draw(poseStack, "Delete", this.x + 6f, this.y + 4f, Color(0, 0, 0, 1).toARGB())
    }
}