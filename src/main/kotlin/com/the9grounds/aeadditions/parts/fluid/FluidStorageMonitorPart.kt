...
class FluidStorageMonitorPart(itemStack: ItemStack) :
    ...
    companion object {
        @PartModels
        val MODEL_OFF = ResourceLocation(AEAdditions.ID, "part/fluid_storage_monitor_off")

        @PartModels
        val MODEL_ON = ResourceLocation(AEAdditions.ID, "part/fluid_storage_monitor_on")

        @PartModels
        val MODEL_LOCKED_OFF = ResourceLocation(AEAdditions.ID, "part/fluid_storage_monitor_locked_off")

        @PartModels
        val MODEL_LOCKED_ON = ResourceLocation(AEAdditions.ID, "part/fluid_storage_monitor_locked_on")
