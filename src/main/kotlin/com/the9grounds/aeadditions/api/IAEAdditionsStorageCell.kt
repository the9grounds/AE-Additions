...
interface IAEAdditionsStorageCell<T: IAEStack<T>> : ICellWorkbenchItem {
     ...
     */
    fun isBlackListed(@Nonnull cellItem: ItemStack, @Nonnull requestedAddition: T): Boolean
     ...
     */
    fun isStorageCell(@Nonnull i: ItemStack): Boolean
     ...
     */
    @Nonnull
    fun getChannel(): IStorageChannel<T>
}