...
public class GuiOreDictExport extends GuiBase {
	...
	public GuiOreDictExport(EntityPlayer player, PartOreDictExporter _part) {
		super(new ResourceLocation(Constants.MOD_ID, "textures/gui/oredictexport.png"), new ContainerOreDictExport(player, _part));
	}
	...
	protected void drawGuiContainerForegroundLayer(int mouseX, int mouseY) {
		...
		this.fontRenderer.drawString(
			I18n.translateToLocal(
				"com.the9grounds.aeadditions.part.oredict.export.name").replace("ME ",
				""), 8, 5, 0x000000);
		this.fontRenderer.drawString(
	...
	public void initGui() {
		...
		this.buttonList.add(new GuiButton(1,
			...
			I18n.translateToLocal("com.the9grounds.aeadditions.tooltip.save")));
