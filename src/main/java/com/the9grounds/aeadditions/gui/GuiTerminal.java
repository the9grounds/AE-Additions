...
public class GuiTerminal extends GuiContainer implements IFluidSelectorGui {
	...
	private ResourceLocation guiTexture = new ResourceLocation(Constants.MOD_ID, "textures/gui/terminalfluid.png");
	...
	protected void drawGuiContainerForegroundLayer(int mouseX, int mouseY) {
		this.fontRenderer.drawString(I18n.translateToLocal("com.the9grounds.aeadditions.part." + type.getName() + ".terminal.name").replace("ME ", ""), 9, 6, 0x000000);
		...
		if (this.currentFluid != null) {
			...
			this.fontRenderer.drawString(I18n.translateToLocal("com.the9grounds.aeadditions.tooltip.amount") + ": " + amountToText, 45, 91, 0x000000);
			this.fontRenderer.drawString(I18n.translateToLocal("com.the9grounds.aeadditions.tooltip.fluid") + ": " + this.currentFluid.getFluid().getLocalizedName(this.currentFluid.getFluidStack()), 45, 101, 0x000000);
		}
	}
