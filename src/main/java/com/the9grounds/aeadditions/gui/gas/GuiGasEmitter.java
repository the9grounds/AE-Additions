...
import com.the9grounds.aeadditions.gui.widget.DigitTextField;
...
public class GuiGasEmitter extends GuiBase<ContainerGasEmitter> implements IFluidSlotGui {
	...
	public GuiGasEmitter(PartGasLevelEmitter part, EntityPlayer player) {
		super(new ResourceLocation(Constants.MOD_ID, "textures/gui/levelemitterfluid.png"), new ContainerGasEmitter(part, player));
		this.part = part;
