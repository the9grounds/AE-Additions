...
public class DriverGasImportBus extends DriverBase<com.the9grounds.aeadditions.part.gas.PartGasImport> {
	...
	private static com.the9grounds.aeadditions.part.gas.PartGasImport getImportBus(World world, BlockPos pos, AEPartLocation dir){
		...
		if(dir == null || dir == AEPartLocation.INTERNAL){
			for (AEPartLocation side: AEPartLocation.SIDE_LOCATIONS){
				...
				if (part != null && part instanceof com.the9grounds.aeadditions.part.gas.PartGasImport)
					return (com.the9grounds.aeadditions.part.gas.PartGasImport) part;
			}
			return null;
		}else{
			IPart part = host.getPart(dir);
			return part == null ? null : part instanceof com.the9grounds.aeadditions.part.gas.PartGasImport ? (com.the9grounds.aeadditions.part.gas.PartGasImport) part : null;
		}
	}
	...
	public class Enviroment extends AbstractManagedEnvironment implements NamedBlock {
		...
		public Object[] getGasImportConfiguration(Context context, Arguments args) {
			...
			com.the9grounds.aeadditions.part.gas.PartGasImport part = OCUtils.getPart(tile.getWorld(), tile.getPos(), dir, com.the9grounds.aeadditions.part.gas.PartGasImport.class);
			if (part == null) {
