...
public class HardDriveModel implements IModel {
	...
	private static final Map<DriveSlotState, ResourceLocation> MODELS_CELLS = ImmutableMap.of(
		DriveSlotState.EMPTY, new ResourceLocation(Constants.MOD_ID + ":block/drive_cell_empty"),
		DriveSlotState.OFFLINE, new ResourceLocation(Constants.MOD_ID + ":block/drive_cell_off"),
		DriveSlotState.ONLINE, new ResourceLocation(Constants.MOD_ID + ":block/drive_cell_on"),
		DriveSlotState.TYPES_FULL, new ResourceLocation(Constants.MOD_ID + ":block/drive_cell_types_full"),
		DriveSlotState.FULL, new ResourceLocation(Constants.MOD_ID + ":block/drive_cell_full")
	);
