...
import com.the9grounds.aeadditions.forge.core.CreativeTab
...
import com.the9grounds.aeadditions.forge.items.storage.StorageCell
import com.the9grounds.aeadditions.forge.items.storage.SuperStorageCell
...
object Items {
    ...
    val ITEM_STORAGE_CELL_4096k = createItem(Ids.ITEM_STORAGE_CELL_4096) { properties ->  StorageCell(properties.stacksTo(1).rarity(Rarity.RARE), CELL_COMPONENT_4096k, AEItems.ITEM_CELL_HOUSING, 5.0, 8192, 4096, 150, AEKeyType.items())}
...
//    }
    ...
    fun <T: Item> createItem(id: ResourceLocation, factory: (Item.Properties) -> T, registry: DeferredRegister<Item>): RegistrySupplier<T>? {
        return registry.register(id.path) {
            constructItem(factory, id)
        }
    }

    fun <T: Item> createItem(id: ResourceLocation, factory: (Item.Properties) -> T, registry: DeferredRegister<Item>, vararg requiredMod: Mods): RegistrySupplier<T>? {
        return registry.register(id.path) {
